...
function IdeaCenter() {
  ...
  return (
    <div className="w-full lg:flex flex-col items-center justify-center lg:p-5 bg-white lg:bg-gray-100 h-[90vh] overflow-hidden">
      <div className="w-full lg:bg-white rounded-lg shadow-md p-3 flex flex-col h-full">
        <div className="flex md:hidden gap-5  mb-4">
          <button
        ...
        <div className="flex flex-col md:flex-row h-full">
          <div
            className={`w-full md:w-1/3 flex flex-col p-4 lg:border-r ${
          ...
          >
            {selectedIdeaIndex !== null && ideas[selectedIdeaIndex] ? (
              <div className="w-full bg-white rounded-lg shadow-md flex flex-col transition-all duration-500 ease-out h-full">
                ...
                <div className="flex-1 overflow-auto p-4 space-y-4 max-h-[40vh] lg:max-h-none lg:h-[calc(100vh-200px)] md:h-auto">
